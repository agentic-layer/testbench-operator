...
def publish_metrics(
    ...
    for metric_name, score in overall_scores.items():
        logger.info(f"  - evaluation_{metric_name}{{workflow_name=\"{workflow_name}\"}}: {score}")
...
if __name__ == "__main__":
    ...
    Examples:
            python3 scripts/evaluate.py weather-assistant-test 
            python3 scripts/evaluate.py weather-assistant-test pushgateway-url.com
    """
